...
//      $domain = $_GET['unblock'];
      ...
      exec(" /usr/bin/sudo /usr/local/bin/pihole -w ".$toUnblock."; /usr/bin/sudo pihole restartdns reload-lists");
      shell_exec(" /usr/bin/sudo /usr/local/bin/pihole -w ".$toUnblock."; /usr/bin/sudo pihole restartdns reload-lists");
//      shell_exec($log);
//      shell_exec($rmlog);
...
//      exec("( /usr/bin/sleep ".$GLOBALS['unblockTimeSec']."; /usr/local/bin/pihole -w -d "rawurldecode(.$GLOBALS['url'].)" ) &");
      exec("( /usr/bin/sleep ".$GLOBALS['unblockTimeSec']."; /usr/bin/sudo /usr/local/bin/pihole -w -d ".$toUnblock."; /usr/bin/sudo pihole restartdns reload-lists ) &");
      shell_exec("( /usr/bin/sleep ".$GLOBALS['unblockTimeSec']."; /usr/bin/sudo /usr/local/bin/pihole -w -d ".$toUnblock."; /usr/bin/sudo pihole restartdns reload-lists ) &");
